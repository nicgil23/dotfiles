...
# Set some variables
wall_dir="${HOME}/Pictures/wallpapers/walls-catppuccin-mocha"
theme="default"
...
# Cálculo de DPI: $dotsperinch = \frac{monitor\_res}{physical\_monitor\_size}$
...
# Movido arriba para que rofi_command pueda usarlo
rofi_override="element-icon{size:${monitor_res}px;border-radius:0px;}"
rofi_command="rofi -x11 -dmenu -theme ${HOME}/.config/rofi/wallpaper-changer/wallSelect.rasi -theme-str ${rofi_override}"
