...
Item {
    ...
    property int implicitSize: 18 * Appearance.effectiveScale
    property int lineWidth: 2 * Appearance.effectiveScale
    ...
    property int fillOverflow: 2 * Appearance.effectiveScale
    ...
    property real arcRadius: root.implicitSize / 2 - root.lineWidth / 2 - (0.5 * Appearance.effectiveScale * root.accountForLightBleeding)
