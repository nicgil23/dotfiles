...
Singleton {
    ...
    property bool previousAutoHide: false
    ...
    function updateStatusBar() {
        ...
        if (root.active) {
            root.previousAutoHide = Config.options.statusBar.autoHide;
            Config.options.statusBar.autoHide = true;
        } else {
            Config.options.statusBar.autoHide = root.previousAutoHide;
        }
    }
