...
Item {
    ...
    Rectangle {
                                        ...
                                        RowLayout {
                                            ...
                                            RippleButton {
                                             ...
                                             RippleButton {
                                                 ...
                                                 implicitWidth: 36 * Appearance.effectiveScale; implicitHeight: 36 * Appearance.effectiveScale; buttonRadius: 18 * Appearance.effectiveScale; colBackground: "transparent"
                                                 MaterialSymbol {
                                                     anchors.centerIn: parent; text: "delete"; iconSize: 20 * Appearance.effectiveScale
                                                     fill: deleteBtn.hovered ? 1 : 0
                                                     color: deleteBtn.hovered ? "#ff5252" : "#FFFFFF"
                                                     Behavior on color { ColorAnimation { duration: 200 } }
                                                 }
                                                 onClicked: {
                                                     mainSelector.fileToDeletePath = currentFilePath;
                                                     mainSelector.fileToDeleteName = currentFileName;
                                                     mainSelector.confirmDeleteVisible = true;
                                                 }
                                                 StyledToolTip { text: "Delete wallpaper" }
                                             }
        ...
        MouseArea {
            ...
            anchors.fill: parent
            visible: mainSelector.confirmDeleteVisible
            z: 200
            hoverEnabled: true
            onPressed: {} // Block clicks from falling through
            ...
            Rectangle {
                ...
                height: deleteConfirmCol.implicitHeight + (48 * Appearance.effectiveScale)
                color: Appearance.colors.colLayer1
                radius: 28 * Appearance.effectiveScale
                border.width: 1
                border.color: Appearance.colors.colOutlineVariant
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        text: "Are you sure you want to delete '" + mainSelector.fileToDeleteName + "'?\nThis action cannot be undone."
                        font.pixelSize: Appearance.font.pixelSize.normal
                        color: Appearance.colors.colOnLayer1
                        wrapMode: Text.WordWrap
                        Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        RippleButton {
                            ...
                            colText: Appearance.colors.colOnLayer2
                            onClicked: {
                                mainSelector.confirmDeleteVisible = false;
                            }
                        }
                            ...
                            onClicked: {
                                if (mainSelector.fileToDeletePath !== "") {
                                    ...
                                    Quickshell.execDetached([
                                        ...
                                        "-a", "NAnDoroid",
                                        "-i", iconPath,
                                        "--", "Wallpaper Deleted", mainSelector.fileToDeleteName + " was removed."
                                    ]);
                                }
                                mainSelector.confirmDeleteVisible = false;
                                mainSelector.fileToDeletePath = "";
                                mainSelector.fileToDeleteName = "";
                            }
                        }
                    }
                }
