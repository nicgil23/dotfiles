        ...
        switch (action) {
            case ScreenshotAction.Action.Copy:
                ...
                return [
                    ...
                    savePath="${shellEscape(finalSaveDir)}/$saveFileName" && \
            ...
            case ScreenshotAction.Action.Record:
                return ["bash", "-c", `'${recordScript}' --region '${slurpRegion}' --path '${shellEscape(finalRecDir)}'`]
                
            case ScreenshotAction.Action.RecordWithSound:
                return ["bash", "-c", `'${recordScript}' --region '${slurpRegion}' --sound --path '${shellEscape(finalRecDir)}'`]
            
            case ScreenshotAction.Action.RecordFullscreenWithSound:
                return ["bash", "-c", `'${recordScript}' --fullscreen --sound --path '${shellEscape(finalRecDir)}'`]
