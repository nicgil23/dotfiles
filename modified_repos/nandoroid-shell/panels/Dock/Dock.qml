            ...
            PanelWindow {
                ...
                visible: {
                    ...
                    if (Config.options.dock.showOnlyInDesktop) {
                        ...
                        // If autoHide is on, we stay visible (but offset) to allow hover reveals
                ...
                MouseArea {
                    ...
                    height: {
                        ...
                        const regionHeight = (Config.options.dock.hoverRegionHeight ?? 3) * Appearance.effectiveScale;
                        return dockWindow.reveal ? parent.height : regionHeight;
                    }
