...
/*
 * nandoroid-shell - Quickshell UI for Hyprland
 *
 * Original work Copyright (C) na-ive (https://github.com/na-ive/nandoroid-shell)
 * Derivative work / modifications Copyright (C) 2026 nicgil23
 *
