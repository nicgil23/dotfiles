...
Scope {
    Variants {
        ...
        PanelWindow {
            ...
            property string defaultBaseFolder: StandardPaths.writableLocation(StandardPaths.PicturesLocation) + "/wallpapers/walls-catppuccin-mocha"

            property string defaultStaticWallpaperFolder: StandardPaths.writableLocation(StandardPaths.PicturesLocation) + "/wallpapers/walls-catppuccin-mocha"
            ...
            function applyWallpaper(item) {
                ...
                var scriptPath = home + "/.local/bin/wallpaper-apply.sh";
